    ...
    if (!localT) {
      ...
      if (localTs >= remoteTs) {
        map.set(key, {
          ...
          mountainName: localT.mountainName !== undefined ? localT.mountainName : (remoteT.mountainName ?? ''),
          sect: localT.sect !== undefined ? localT.sect : (remoteT.sect ?? ''),
          chiefPriest: localT.chiefPriest !== undefined ? localT.chiefPriest : (remoteT.chiefPriest ?? ''),
          postalCode: localT.postalCode !== undefined ? localT.postalCode : (remoteT.postalCode ?? ''),
          address: localT.address !== undefined ? localT.address : (remoteT.address ?? ''),
          phone: localT.phone !== undefined ? localT.phone : (remoteT.phone ?? ''),
          fax: localT.fax !== undefined ? localT.fax : (remoteT.fax ?? ''),
          website: localT.website !== undefined ? localT.website : (remoteT.website ?? ''),
          bankInfo: localT.bankInfo !== undefined ? localT.bankInfo : (remoteT.bankInfo ?? ''),
        ...
        map.set(key, {
          ...
          mountainName: remoteT.mountainName !== undefined ? remoteT.mountainName : (localT.mountainName ?? ''),
          sect: remoteT.sect !== undefined ? remoteT.sect : (localT.sect ?? ''),
          chiefPriest: remoteT.chiefPriest !== undefined ? remoteT.chiefPriest : (localT.chiefPriest ?? ''),
          postalCode: remoteT.postalCode !== undefined ? remoteT.postalCode : (localT.postalCode ?? ''),
          address: remoteT.address !== undefined ? remoteT.address : (localT.address ?? ''),
          phone: remoteT.phone !== undefined ? remoteT.phone : (localT.phone ?? ''),
          fax: remoteT.fax !== undefined ? remoteT.fax : (localT.fax ?? ''),
          website: remoteT.website !== undefined ? remoteT.website : (localT.website ?? ''),
          bankInfo: remoteT.bankInfo !== undefined ? remoteT.bankInfo : (localT.bankInfo ?? ''),
...
export function mergeDatasetsWithAuditPriority(
  ...
  if (!remoteMainTemple || !remoteMainTemple.name) {
    ...
    mergedTempleInfo = {
      ...remoteMainTemple,
      ...localMainTemple,
      name: localMainTemple?.name !== undefined && localMainTemple.name !== '' ? localMainTemple.name : (remoteMainTemple?.name || INITIAL_TEMPLE_INFO.name),
      address: localMainTemple?.address !== undefined ? localMainTemple.address : (remoteMainTemple?.address || ''),
      phone: localMainTemple?.phone !== undefined ? localMainTemple.phone : (remoteMainTemple?.phone || ''),
      postalCode: localMainTemple?.postalCode !== undefined ? localMainTemple.postalCode : (remoteMainTemple?.postalCode || ''),
      fax: localMainTemple?.fax !== undefined ? localMainTemple.fax : (remoteMainTemple?.fax || ''),
      website: localMainTemple?.website !== undefined ? localMainTemple.website : (remoteMainTemple?.website || ''),
      chiefPriest: localMainTemple?.chiefPriest !== undefined ? localMainTemple.chiefPriest : (remoteMainTemple?.chiefPriest || ''),
      sect: localMainTemple?.sect !== undefined ? localMainTemple.sect : (remoteMainTemple?.sect || ''),
      mountainName: localMainTemple?.mountainName !== undefined ? localMainTemple.mountainName : (remoteMainTemple?.mountainName || ''),
      bankInfo: localMainTemple?.bankInfo !== undefined ? localMainTemple.bankInfo : (remoteMainTemple?.bankInfo || ''),
    ...
    mergedTempleInfo = {
      ...localMainTemple,
      ...remoteMainTemple,
      name: remoteMainTemple?.name !== undefined && remoteMainTemple.name !== '' ? remoteMainTemple.name : (localMainTemple?.name || INITIAL_TEMPLE_INFO.name),
      address: remoteMainTemple?.address !== undefined ? remoteMainTemple.address : (localMainTemple?.address || ''),
      phone: remoteMainTemple?.phone !== undefined ? remoteMainTemple.phone : (localMainTemple?.phone || ''),
      postalCode: remoteMainTemple?.postalCode !== undefined ? remoteMainTemple.postalCode : (localMainTemple?.postalCode || ''),
      fax: remoteMainTemple?.fax !== undefined ? remoteMainTemple.fax : (localMainTemple?.fax || ''),
      website: remoteMainTemple?.website !== undefined ? remoteMainTemple.website : (localMainTemple?.website || ''),
      chiefPriest: remoteMainTemple?.chiefPriest !== undefined ? remoteMainTemple.chiefPriest : (localMainTemple?.chiefPriest || ''),
      sect: remoteMainTemple?.sect !== undefined ? remoteMainTemple.sect : (localMainTemple?.sect || ''),
      mountainName: remoteMainTemple?.mountainName !== undefined ? remoteMainTemple.mountainName : (localMainTemple?.mountainName || ''),
      bankInfo: remoteMainTemple?.bankInfo !== undefined ? remoteMainTemple.bankInfo : (localMainTemple?.bankInfo || ''),
