    ...
    <div className="space-y-2">
      <div className="space-y-2 no-print">
        ...
        <div className="bg-white border border-[#D1CEC7] shadow-sm overflow-hidden space-y-2 p-2.5 sm:p-3 font-serif">
          ...
          <div ref={scrollContainerRef} className="max-h-[calc(100vh-190px)] min-h-[480px] overflow-y-auto overflow-x-auto relative border border-[#D1CEC7] bg-white shadow-xs">
